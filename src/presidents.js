...
function getNamesAndParty(presidentsArr) {
  const arr = [];
  const presidentsObj = presidentsArr.map((president) => ({
    name: president.name,
    party: president.party,
  }));
  return presidentsObj;
}
...
function getDemocraticPresidents(presidentsArr) {
  const filterDem = presidentsArr.filter(
...
function getAffiliatedPresidents(presidentsArr) {
  const filteredArr = presidentsArr.filter(
...
function countYearsInOffice(presidentsArr) {
  const countTotalYearsInOffice = presidentsArr.reduce((acc, president) => {
...
function sortPresidentsByBirthYear(presidentsArr) {
  const sort = presidentsArr.sort((a, b) => {
...
function getAgeAtInauguration(presidentsArr) {
  const presidentsObjAge = presidentsArr.map((president) => {
    const newPresident = {
      ...president,
...
function getPresidentsBornAfter(presidentsArr, year) {
  const filterPresident = presidentsArr.filter(
...
function sortPresidentsByName(presidentsArr) {
  const alphabethic = presidentsArr.sort((a, b) => {
